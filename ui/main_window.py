...
class LoginWindow:
    ...
    def create_widgets(self):
        ...
        # Кнопки
        tk.Button(self.root, text="Войти", command=self.authenticate).pack(pady=10)
        tk.Button(self.root, text="Войти как пользователь", command=self.open_user_window).pack(pady=10)
